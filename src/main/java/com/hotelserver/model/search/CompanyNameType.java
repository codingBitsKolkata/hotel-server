...
@XmlSeeAlso({
    ...
    com.hotelserver.model.search.ContactInfoType.CompanyName.class,
    CompanyNamePrefType.class,
    com.hotelserver.model.search.AllianceConsortiumType.AllianceMember.class,
    com.hotelserver.model.search.DirectBillType.CompanyName.class,

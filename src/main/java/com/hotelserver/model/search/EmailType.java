...
@XmlSeeAlso({
    com.hotelserver.model.search.EmailsType.Email.class,
    com.hotelserver.model.search.CustomerType.Email.class,
    com.hotelserver.model.search.CompanyInfoType.Email.class
})

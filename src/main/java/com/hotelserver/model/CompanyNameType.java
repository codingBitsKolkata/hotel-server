...
@XmlSeeAlso({
    ...
    com.hotelserver.model.ContactInfoType.CompanyName.class,
    CompanyNamePrefType.class,
    com.hotelserver.model.AllianceConsortiumType.AllianceMember.class,
    com.hotelserver.model.DirectBillType.CompanyName.class,

...
@XmlSeeAlso({
    com.hotelserver.model.AffiliationInfoType.LoyalPrograms.LoyalProgram.ProgramDescription.class,
    com.hotelserver.model.AffiliationInfoType.LoyalPrograms.LoyalProgram.ProgramRestriction.class,
    com.hotelserver.model.ProfileType.Comments.Comment.class,
    com.hotelserver.model.CommentType.Comment.class,
    com.hotelserver.model.SpecialRequestType.SpecialRequest.class,
    DescriptionType.class,
    com.hotelserver.model.InvBlockType.BlockDescriptions.BlockDescription.class
})

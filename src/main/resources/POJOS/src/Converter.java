...
import org.soaps.OTAHotelAvailRS;
import org.soaps.RatePlan;
import org.soaps.RoomRate;
import org.soaps.TPAExtensions;
import org.soaps.TPAExtensions____;
...
public class Converter {
	...
	public void convert(String response) throws IOException, ParseException {
		...
		OTAHotelAvailRS availRS=gson.fromJson(new JSONObject(jsonPrettyPrintString).optJSONObject("soap:Envelope")
